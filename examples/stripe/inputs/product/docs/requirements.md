<!-- source: https://docs.stripe.com/connect/required-verification-information.md | retrieved: 2026-05-15T20:15:51Z -->
...
1. **Fallback document review**: If programmatic verification fails, the representative must upload an acceptable relationship document (for simple ownership structures) or attestation (for complex ownership structures).
